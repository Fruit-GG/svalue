...
{    
    ...
    G4double probability[14];
    probability[0] = 1.98;
    probability[1] = 0.0193;
    probability[2] = 0.747;
    probability[3] = 1.1;
    probability[4] = 0.991;
    probability[5] = 0.0868;
    probability[6] = 0.0137;
    probability[7] = 0.0012;
    probability[8] = 0.0126;
    probability[9] = 0.0047;
    probability[10] = 0.0843;
    probability[11] = 0.0059;
    probability[12] = 0.0136;
    probability[13] = 0.0062;





    G4double final_probability = 5.0663 * G4UniformRand();
...
G4bool PrimaryGeneratorAction::Notify(G4ApplicationState requestedState)
{
  ...
  //G4cout << "PrimaryGeneratorAction::Notify 已被调用" << G4endl;
